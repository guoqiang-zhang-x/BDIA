...
One can also apply the BDIA technique to the EDM and DPM-Solver++ sampling procedures. Experiments on BDIA-EDM show that it outperforms EDM consitently over four pre-trained models in terms of FID scores.  The details can found out in the paper. 
...
<a href="URL_REDIRECT" target="blank"><img align="center" src="https://github.com/guoqiang-zhang-x/BDIA/blob/main/image_examples/controlnet_BDIA.eps" width="900" /></a>
