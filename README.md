...
```math
\boldsymbol{z}_{i-1} = \boldsymbol{z}_{i+1}+ \gamma (\boldsymbol{z}_{i}-\boldsymbol{z}_{i+1}) + (1-\gamma)\Delta(t_i\rightarrow t_{i+1}|\boldsymbol{z}_i) + \Delta(t_i\rightarrow t_{i+1}|\boldsymbol{z}_i)
```
